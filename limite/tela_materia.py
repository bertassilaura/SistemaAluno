...
class TelaMateria(TelaAbstrata):
    ...
    def tela_opcoes(self):
        ...
        window = sg.Window('Tela Matéria', size=(450, 520),  element_justification="c", grab_anywhere=True, default_element_size=(40, 1)).Layout(layout)
    ...
    def pega_dados(self):
        ...
        layout = [
            ...
            [sg.Text('ID do professor', font=fonte_texto, size=tamanho_texto), sg.InputText('Se não houver, deixe em branco', key = 'professor')],
    ...
    def mostra_dados(self, materia: Materia):
        ...
        window = sg.Window('Lista de matérias', size=(450,580), element_justification="c", grab_anywhere=True).Layout(layout)
        button, values = window.Read()
        window.close()
        return values
